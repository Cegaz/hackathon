...
function getMeteobyId($id){

    $responseWeather = Unirest\Request::get('http://api.openweathermap.org/data/2.5/weather?id=' . $id . '&units=metric&lang=fr&APPID=606cacb6613414904494ad93ffab0aaa');
    ...
    //$data['country'] = $parsed_json->{'country'};
